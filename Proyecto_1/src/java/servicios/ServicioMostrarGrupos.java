...
public class ServicioMostrarGrupos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           System.out.println("servicios.ServicioMostrarGrupos.processRequest()"+GestorDatos.obtenerInstancia().obterTablaGrupo().length());
           out.println(GestorDatos.obtenerInstancia().obterTablaGrupo());
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServicioMostrarGrupos.class.getName()).log(Level.SEVERE, null, ex);
