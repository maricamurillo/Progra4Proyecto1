...
public class ServicioEstudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int control = Integer.parseInt(request.getParameter("ordenar"));
            System.out.println("servicios.ServicioEstudiante.processRequest()"+control);
            out.println(GestorDatos.obtenerInstancia().obtenerTablaEstudiante(control));
        }
    }
